...
namespace AbyssMoth
{
    ...
    {
        public const string CopyHierarchyMenu = "AbyssMoth/Copy Selection/Hierarchy Path %&v";
        ...
        public const string HierarchyHotkeyDescription = "Cmd+Option+V on macOS, Ctrl+Alt+V on Windows";
